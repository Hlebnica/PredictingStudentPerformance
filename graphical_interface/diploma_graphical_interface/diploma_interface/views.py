...
def get_data_analysis(request):
    ...
    predictive_model_names = {
        ...
        'model3': 'Предсказание успеваемости прохождения практик',
        'model4': 'Предсказания вероятности отчисления по экзаменам или зачетам',
...
def predictive_model_result(predictive_model_object: PredictiveModels, predictive_model, selected_subject, type_of_control, 
    ...
    print(f'\n\ntype_of_control_inner:::::::::: {type_of_control_inner}\n\n')
...
def predition_page(request):
    ...
    if request.method == 'POST':
        ...
        print(f'\n\n dfStudentsByJournalId_predict {dfStudentsByJournalId_predict}  \n\n')

        # Запрос оценок за предмет по id за N год
        dfRatingByJournalId_predict = asyncio.run(AsyncRequests.rating_by_journal_id(dfByYear_predict[0]))
        
        print(f'\n\n dfRatingByJournalId_predict {dfRatingByJournalId_predict}  \n\n')
        ...
        print(f'\n\n dfEgeMarksByStudentsId_predict {dfEgeMarksByStudentsId_predict}  \n\n')
        ...
        print(f'\n\n predictive_model_object_predict {predictive_model_object_predict}  \n\n')
        ...
        print(f'\n\n df_predictive_model_predict {df_predictive_model_predict}  \n\n')
